...
<div class="row">
	<div class="category <!-- IF widgets.sidebar.length -->col-lg-9 col-sm-12<!-- ELSE -->col-lg-12<!-- ENDIF widgets.sidebar.length -->">
		...
		<div class="clearfix">
			...
			<a href="{config.relative_path}/compose?cid={cid}" component="category/post" id="new_topic" class="btn btn-primary" data-ajaxify="false" role="button" style="background-color: #e14f3d; border: none">[[category:new_topic_button]]</a>
			<!-- ELSE -->
				<!-- IF !loggedIn -->
